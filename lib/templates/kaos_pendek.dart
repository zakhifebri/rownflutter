...
import 'package:rown/templates/kaos_pendek_detail.dart'; // Pastikan ini sesuai dengan path file detail

class KaosPendekPage extends StatelessWidget {
  const KaosPendekPage({super.key});

  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: const Text('Produk Kaos Pendek')),
      body: StreamBuilder<QuerySnapshot>(
        stream: FirebaseFirestore.instance.collection('produk').where('kategori', isEqualTo: 'Kaos Pendek').snapshots(),
                ...
                ElevatedButton(
                  ...
                  onPressed: () {
                    Navigator.push(
                      context,
                      MaterialPageRoute(
                        builder: (context) => KaosPendekDetailPage(
                          name: name,
                          price: price,
                          imagePath: imagePath,
