...
import 'package:rown/templates/perempuan_detail.dart'; // Pastikan ini sesuai dengan path file detail

class PerempuanPage extends StatelessWidget {
  const PerempuanPage({super.key});

  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: const Text('Produk Perempuan')),
      body: StreamBuilder<QuerySnapshot>(
        stream: FirebaseFirestore.instance.collection('produk').where('kategori', isEqualTo: 'Perempuan').snapshots(),
                ...
                ElevatedButton(
                  ...
                  onPressed: () {
                    Navigator.push(
                      context,
                      MaterialPageRoute(
                        builder: (context) => PerempuanDetailPage(
                          name: name,
                          price: price,
                          imagePath: imagePath,
