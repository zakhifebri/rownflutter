...
import 'package:rown/templates/kaos_panjang_detail.dart'; // Pastikan ini sesuai dengan path file detail

class KaosPanjangPage extends StatelessWidget {
  const KaosPanjangPage({super.key});

  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: const Text('Produk Kaos Panjang')),
      body: StreamBuilder<QuerySnapshot>(
        stream: FirebaseFirestore.instance.collection('produk').where('kategori', isEqualTo: 'Kaos Panjang').snapshots(),
            ...
            child: GridView.builder(
              ...
              itemBuilder: (context, index) {
                ...
                return _buildProductBox(
                  context,
                  produk['gambar'] ?? 'lib/images/default.png',
                ...
                ElevatedButton(
                  ...
                  onPressed: () {
                    Navigator.push(
                      context,
                      MaterialPageRoute(
                        builder: (context) => KaosPanjangDetailPage(
                          name: name,
                          price: price,
                          imagePath: imagePath,
